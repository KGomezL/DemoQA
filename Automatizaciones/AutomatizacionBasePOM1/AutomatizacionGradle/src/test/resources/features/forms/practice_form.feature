...
Característica:  Como usuario del sistema ToolsQA deseo verificar el elemento practice form del modulo Forms para
...
#      | <Nombre> | <Apellido> | <Email> | <Genero> | <Telefono> | <Fecha> | <Subjects> | <CurrentAdd> | <State> | <City> |
    ...
    Ejemplos:
      ...
      | Forms      | Practice Form | Pedro  | Prueba   | segunda@prueba.com | Female | 3013589633 |
